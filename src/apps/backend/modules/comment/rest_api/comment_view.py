...
class CommentView(MethodView):
    ...
    def post(self, account_id: str, task_id: str) -> ResponseReturnValue:
        ...
        if not request_data.get("text"):
            raise CommentBadRequestError("Text is required inside a comment")

        create_comment_params = CreateCommentParams(
            author_id=account_id, task_id=task_id, text=request_data["text"]
        )
    ...
    def get(self, account_id: str, task_id: str, comment_id: Optional[str] = None) -> ResponseReturnValue:
        if comment_id:
            comment_params = GetCommentParams(author_id=account_id, task_id=task_id, comment_id=comment_id)
            ...
            comments_params = GetPaginatedCommentsParams(author_id=account_id, task_id=task_id, pagination_params=pagination_params)
    ...
    def patch(self, account_id: str, task_id: str, comment_id: str) -> ResponseReturnValue:
        ...
        update_comment_params = UpdateCommentParams(
            author_id=account_id, task_id=task_id, comment_id=comment_id, text=request_data["text"]
        )
    ...
    def delete(self, account_id: str, task_id: str, comment_id: str) -> ResponseReturnValue:
        delete_params = DeleteCommentParams(author_id=account_id, task_id=task_id, comment_id=comment_id)
