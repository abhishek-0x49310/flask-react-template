...
class TestCommentApi(BaseTestComment):
    ...
    def test_delete_comment_success(self) -> None:
        ...
        delete_response = self.make_authenticated_request("DELETE", account.id, token, task.id, comment_id=created_comment.id)
    ...
    def test_delete_comment_not_found(self) -> None:
        ...
        response = self.make_authenticated_request("DELETE", account.id, token, task.id, comment_id=non_existent_comment_id)
